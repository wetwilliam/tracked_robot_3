...
int lm=0;//leg_motion
int body_left_speed = 700;
int body_right_speed = 700;
int leg_front_speed = 200;
int leg_back_speed = 200;
...
//=======ROS_init=========================================
   ...
   //ros::Subscriber subENC = n.subscribe("Rd_enc", 10000, ReadEnc);
	...
	fd_Slim5 = open(serialPortName, O_RDWR | O_NOCTTY | O_NONBLOCK);
   ...
   Motor_acc(3, 300);
   std::cout << "Initialization is completed ...\n";
   pthread_mutex_unlock(&mutex);//lock off
   usleep(2000);	
